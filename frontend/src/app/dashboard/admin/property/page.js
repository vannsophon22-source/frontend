        ...
        : "Unknown Owner"}
                        ...
                        <td className="px-6 py-4">
                          <div className="flex gap-2">
                            <button
                              onClick={() => router.push(`/dashboard/admin/property/${property.id}/units/create`)}
                            ...
                            <button
                              onClick={() => router.push(`/dashboard/admin/property/${property.id}/edit`)}
                                  ...
                                  property.units.map((unit) => (
                                    <div key={unit.id} className="bg-[#0a2a2b] rounded-xl p-4 border border-emerald-500/20 hover:border-emerald-500/40 transition-all">
                                      ...
                                      <div className="flex justify-end gap-2 mt-3 pt-3 border-t border-emerald-500/20">
                                        <button
                                          onClick={() => router.push(`/dashboard/admin/units/edit/${unit.id}`)}

                              ...
                              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                {property.units?.length > 0 ? (
                                  property.units.map((unit) => (
                                    <div
                                      key={unit.id}
                                      className="bg-[#0a2a2b] rounded-xl p-4 border border-emerald-500/20 hover:border-emerald-500/40 transition-all"
                                    >
                                      ...
                                      <div className="flex justify-end gap-2 mt-3 pt-3 border-t border-emerald-500/20">
                                        <button
                                          onClick={() =>
                                            router.push(
                                              `/dashboard/owner/units/edit/${unit.id}`
                                            )
                                          }
                                        ...
                                        <button
                                          onClick={() =>
                                            deleteUnit(unit.id, property.id)
                                          }
                                  ...
                                  <div className="col-span-full text-center py-8 text-gray-400">
                                    ...
                                    <p>
                                      No units available. Click "Add Unit" to
                                      create one.
                                    </p>
                                  </div>
                                )}
            ...
            <div className="p-8">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {filteredProperties.map((property) => (
                  <div
                    key={property.id}
                    className="bg-[#051F20] rounded-xl border border-emerald-500/30 overflow-hidden hover:border-emerald-500/60 transition-all group"
                  >
                    ...
                    <div className="p-4 space-y-3">
                      ...
                      <div className="flex gap-2 pt-2">
                        ...
                        <button
                          onClick={() => deleteProperty(property.id)}
                          cl
                          assName="px-3 py-1.5 bg-rose-500/20 hover:bg-rose-500/30 text-rose-400 rounded-lg text-sm transition-all"
                        >
                          <FaTrash size={14} />
                        </button>
                      </div>
                        ...
                        {property.units?.length > 0 ? (
                          <div className="space-y-2 max-h-64 overflow-y-auto">
                            {property.units.map((unit) => (
                              <div
                                key={unit.id}
                                className="bg-[#0a2a2b] rounded-lg p-2 text-sm"
                              >
                                <div className="flex justify-between items-center">
                                  <div className="flex items-center gap-2">
                                    {getTypeIcon(unit.type)}
